...
public class CustomerRepository {
    ...
    public static List<Customer> getAllCustomer() {
        ...
        List<Vehicle> listCust1Vehicles = Arrays.asList(carCust1, motorCust1);

        Customer cust1 = new Customer("Cust-001", "Budi", "Bandung", "cust001", listCust1Vehicles, "Non Member");
        Vehicle motorCust2 = new Motorcyle("D6734ZD", "Merah", "Honda", "Otomatis", 2019, 125);
        List<Vehicle> listCust2Vehicles = Arrays.asList(motorCust2);

        Customer cust2 = new Customer("Cust-002", "Yanto", "Bandung", "cust002", listCust2Vehicles, "Non Member");
        ...
        List<Vehicle> listCust3Vehicles = Arrays.asList(carCust3, motorCust3);

        Customer cust3 = new MemberCustomer("Cust-003", "Rahmat", "Garut", "cust003", listCust3Vehicles, "Member", 2000000);
